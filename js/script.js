...
function setupJuryArchiveCarousel() {
  ...
  const style = document.createElement('style'); style.textContent = `.jury-carousel-frame{position:relative;width:100%;aspect-ratio:16/9;min-height:360px;background:#20201d;overflow:hidden}.jury-carousel-slide{position:absolute;inset:0;opacity:0!important;pointer-events:none;transition:opacity .25s ease}.jury-carousel-slide.active{opacity:1!important;pointer-events:auto}.jury-carousel-slide img{width:100%!important;height:100%!important;object-fit:contain!important;display:block!important}.jury-carousel-control{position:absolute;top:50%;z-index:2;transform:translateY(-50%);width:42px;height:42px;border:1px solid rgba(245,241,232,.75);background:rgba(32,32,29,.55);color:#f5f1e8;font-size:24px;line-height:1;cursor:pointer;display:flex;align-items:center;justify-content:center}.jury-carousel-control:hover{background:rgba(32,32,29,.8)}.jury-carousel-control.prev{left:16px}.jury-carousel-control.next{right:16px}@media(max-width:600px){.jury-carousel-frame{min-height:250px}.jury-carousel-control{width:36px;height:36px;font-size:20px}}`; document.head.appendChild(style);
}
