(function () {
  ...
  function translatePage(lang){
    ...
    while((n=walker.nextNode())){
      const p=n.parentElement;if(!p||['SCRIPT','STYLE','NOSCRIPT'].includes(p.tagName)||p.closest('.language-switcher')||p.closest('[data-i18n-no-translate]')||p.closest('[data-i18n-html="true"]')||p.closest('a[href^="mailto:"]'))continue;
